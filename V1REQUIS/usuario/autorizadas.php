...
$requis=$conectar->query("SELECT usuarios.*, solicitudes.*, departamentos.* FROM solicitudes 
    ...
    INNER JOIN departamentos ON usuarios.departamento_id = departamentos.id_depto WHERE estatus='Autorizada' ORDER BY fecha_creacion DESC");
$nr=$requis->num_rows;
...
<head>
    <meta charset="UTF-8">
    <title>Requisiciones autorizadas</title>
            ...
            if($nr>0){
                do{?>
                    <tr>
                        ...
                        <td><a href="../pdf/pdf_requisicion.php?ref=<?php echo md5($key.$arrayr['id_folio']); ?>" target='_blank' class='btn btn-info btn-sm'><i class='fas fa-eye'></i></a></td>
                    </tr>
